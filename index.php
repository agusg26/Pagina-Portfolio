...
<body>
    <header class="header">
        <nav class="navbar navbar-expand-lg navbar-dark container">
            <a class="navbar-brand d-flex align-items-center" href="#fondo">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <!-- Items en el centro con enlaces a las secciones -->
                <ul class="navbar-nav mx-auto text-center gap-lg-2">
                    <li class="nav-item">
                        <a class="nav-link" href="#fondo">Sobre Mí</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#progreso-carrera">Progreso Carrera</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="container-fluid" id="fondo">
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-7">
                <div id="skills">
                    <div class="card bg-transparent text-white text-center border-bottom border-light w-75 mx-auto">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 d-flex justify-content-end">
                <button type="button" class="btn btn-outline-light" id="btnMostrar"><b>Mis conocimientos</b></button>
            </div>
        </div>
        <div class="row">
    ...
    <section class="bg-dark text-white py-5" id="proyectos">
        <div style="text-align: center;">
            <h2>Mis Proyectos</h2>
        </div>
        <br>
    ...
    <section id="contacto" class="py-5">
        <div class="container">
            ...
            <form id="formulario" action="https://formsubmit.co/agusg2600@gmail.com" method="POST">
                ...
                <br>
                <input type="submit" class="btn btn-primary" placeholder="Enviar" name="enviar">
                <input type="hidden" name="_next" value="https://agusg26.github.io/Mi-Portafolio/">
            </form>
        </div>
    </section>
